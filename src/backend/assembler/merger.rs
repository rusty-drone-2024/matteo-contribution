...
impl Assembler {
    pub fn merge_fragment(&mut self, session: SessionId, fragment: Fragment) -> Option<Message> {
    ...
    pub(super) fn get_full_message(&mut self, session: SessionId) -> Option<Message> {
